...
const RestaurantPage = () => {
    ...
    const [restaurant, setRestaurant] = useState<IRestaurant|undefined>(undefined)
...
useEffect(() => {
  ...
  return (
    ...
    { restaurant && <div className='restaurant-page-container'>
          <img
      ...
      <div className='restaurant-page-dish'>
        {restaurantDishes.map((dish)=> <DishCard key={dish._id} dish={dish}/>)}
      </div>
    </div>}
    </>
  )
